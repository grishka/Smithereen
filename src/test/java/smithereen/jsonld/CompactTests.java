...
class CompactTests{
	...
	*/
	...
	void t0001(){
		...
		Object expect=readResource("/compact/0001-out.jsonld");
		JSONObject context=(JSONObject)readResource("/compact/0001-context.jsonld");
		JSONObject compacted=JLDDocument.compact(input, context.get("@context"));
		compacted.put("@context", context.get("@context"));
		JLDUtilities.assertEqualJLD(expect, compacted);
	}
	...
	*/
	...
	void t0002(){
		...
		Object expect=readResource("/compact/0002-out.jsonld");
		JSONObject context=(JSONObject)readResource("/compact/0002-context.jsonld");
		JSONObject compacted=JLDDocument.compact(input, context.get("@context"));
		compacted.put("@context", context.get("@context"));
		JLDUtilities.assertEqualJLD(expect, compacted);
	}
	...
	*/
	...
	void t0003(){
		...
		Object expect=readResource("/compact/0003-out.jsonld");
		JSONObject context=(JSONObject)readResource("/compact/0003-context.jsonld");
		JSONObject compacted=JLDDocument.compact(input, context.get("@context"));
		compacted.put("@context", context.get("@context"));
		JLDUtilities.assertEqualJLD(expect, compacted);
	}
	...
	*/
	...
	void t0004(){
		...
		Object expect=readResource("/compact/0004-out.jsonld");
		JSONObject context=(JSONObject)readResource("/compact/0004-context.jsonld");
		JSONObject compacted=JLDDocument.compact(input, context.get("@context"));
		compacted.put("@context", context.get("@context"));
		JLDUtilities.assertEqualJLD(expect, compacted);
	}
	...
	*/
	...
	void t0005(){
		...
		Object expect=readResource("/compact/0005-out.jsonld");
		JSONObject context=(JSONObject)readResource("/compact/0005-context.jsonld");
		JSONObject compacted=JLDDocument.compact(input, context.get("@context"));
		compacted.put("@context", context.get("@context"));
		JLDUtilities.assertEqualJLD(expect, compacted);
	}
	...
	*/
	...
	void t0006(){
		...
		Object expect=readResource("/compact/0006-out.jsonld");
		JSONObject context=(JSONObject)readResource("/compact/0006-context.jsonld");
		JSONObject compacted=JLDDocument.compact(input, context.get("@context"));
		compacted.put("@context", context.get("@context"));
		JLDUtilities.assertEqualJLD(expect, compacted);
	}
	...
	*/
	...
	void t0007(){
		...
		Object expect=readResource("/compact/0007-out.jsonld");
		JSONObject context=(JSONObject)readResource("/compact/0007-context.jsonld");
		JSONObject compacted=JLDDocument.compact(input, context.get("@context"));
		compacted.put("@context", context.get("@context"));
		JLDUtilities.assertEqualJLD(expect, compacted);
	}
	...
	*/
	...
	void t0008(){
		...
		Object expect=readResource("/compact/0008-out.jsonld");
		JSONObject context=(JSONObject)readResource("/compact/0008-context.jsonld");
		JSONObject compacted=JLDDocument.compact(input, context.get("@context"));
		compacted.put("@context", context.get("@context"));
		JLDUtilities.assertEqualJLD(expect, compacted);
	}
	...
	*/
	...
	void t0009(){
		...
		Object expect=readResource("/compact/0009-out.jsonld");
		JSONObject context=(JSONObject)readResource("/compact/0009-context.jsonld");
		JSONObject compacted=JLDDocument.compact(input, context.get("@context"));
		compacted.put("@context", context.get("@context"));
		JLDUtilities.assertEqualJLD(expect, compacted);
	}
	...
	*/
	...
	void t0010(){
		...
		Object expect=readResource("/compact/0010-out.jsonld");
		JSONObject context=(JSONObject)readResource("/compact/0010-context.jsonld");
		JSONObject compacted=JLDDocument.compact(input, context.get("@context"));
		compacted.put("@context", context.get("@context"));
		JLDUtilities.assertEqualJLD(expect, compacted);
	}
	...
	*/
	...
	void t0011(){
		...
		Object expect=readResource("/compact/0011-out.jsonld");
		JSONObject context=(JSONObject)readResource("/compact/0011-context.jsonld");
		JSONObject compacted=JLDDocument.compact(input, context.get("@context"));
		compacted.put("@context", context.get("@context"));
		JLDUtilities.assertEqualJLD(expect, compacted);
	}
	...
	*/
	...
	void t0012(){
		...
		Object expect=readResource("/compact/0012-out.jsonld");
		JSONObject context=(JSONObject)readResource("/compact/0012-context.jsonld");
		JSONObject compacted=JLDDocument.compact(input, context.get("@context"));
		compacted.put("@context", context.get("@context"));
		JLDUtilities.assertEqualJLD(expect, compacted);
	}
	...
	*/
	...
	void t0013(){
		...
		Object expect=readResource("/compact/0013-out.jsonld");
		JSONObject context=(JSONObject)readResource("/compact/0013-context.jsonld");
		JSONObject compacted=JLDDocument.compact(input, context.get("@context"));
		compacted.put("@context", context.get("@context"));
		JLDUtilities.assertEqualJLD(expect, compacted);
	}
	...
	*/
	...
	void t0014(){
		...
		Object expect=readResource("/compact/0014-out.jsonld");
		JSONObject context=(JSONObject)readResource("/compact/0014-context.jsonld");
		JSONObject compacted=JLDDocument.compact(input, context.get("@context"));
		compacted.put("@context", context.get("@context"));
		JLDUtilities.assertEqualJLD(expect, compacted);
	}
	...
	*/
	...
	void t0015(){
		...
		Object expect=readResource("/compact/0015-out.jsonld");
		JSONObject context=(JSONObject)readResource("/compact/0015-context.jsonld");
		JSONObject compacted=JLDDocument.compact(input, context.get("@context"));
		compacted.put("@context", context.get("@context"));
		JLDUtilities.assertEqualJLD(expect, compacted);
	}
	...
	*/
	...
	void t0016(){
		...
		Object expect=readResource("/compact/0016-out.jsonld");
		JSONObject context=(JSONObject)readResource("/compact/0016-context.jsonld");
		JSONObject compacted=JLDDocument.compact(input, context.get("@context"));
		compacted.put("@context", context.get("@context"));
		JLDUtilities.assertEqualJLD(expect, compacted);
	}
	...
	*/
	...
	void t0017(){
		...
		Object expect=readResource("/compact/0017-out.jsonld");
		JSONObject context=(JSONObject)readResource("/compact/0017-context.jsonld");
		JSONObject compacted=JLDDocument.compact(input, context.get("@context"));
		compacted.put("@context", context.get("@context"));
		JLDUtilities.assertEqualJLD(expect, compacted);
	}
	...
	*/
	...
	void t0018(){
		...
		Object expect=readResource("/compact/0018-out.jsonld");
		JSONObject context=(JSONObject)readResource("/compact/0018-context.jsonld");
		JSONObject compacted=JLDDocument.compact(input, context.get("@context"));
		compacted.put("@context", context.get("@context"));
		JLDUtilities.assertEqualJLD(expect, compacted);
	}
	...
	*/
	...
	void t0019(){
		...
		Object expect=readResource("/compact/0019-out.jsonld");
		JSONObject context=(JSONObject)readResource("/compact/0019-context.jsonld");
		JSONObject compacted=JLDDocument.compact(input, context.get("@context"));
		compacted.put("@context", context.get("@context"));
		JLDUtilities.assertEqualJLD(expect, compacted);
	}
	...
	*/
	...
	void t0020(){
		...
		Object expect=readResource("/compact/0020-out.jsonld");
		JSONObject context=(JSONObject)readResource("/compact/0020-context.jsonld");
		JSONObject compacted=JLDDocument.compact(input, context.get("@context"));
		compacted.put("@context", context.get("@context"));
		JLDUtilities.assertEqualJLD(expect, compacted);
	}
	...
	*/
	...
	void t0021(){
		...
		Object expect=readResource("/compact/0021-out.jsonld");
		JSONObject context=(JSONObject)readResource("/compact/0021-context.jsonld");
		JSONObject compacted=JLDDocument.compact(input, context.get("@context"));
		compacted.put("@context", context.get("@context"));
		JLDUtilities.assertEqualJLD(expect, compacted);
	}
	...
	*/
	...
	void t0022(){
		...
		Object expect=readResource("/compact/0022-out.jsonld");
		JSONObject context=(JSONObject)readResource("/compact/0022-context.jsonld");
		JSONObject compacted=JLDDocument.compact(input, context.get("@context"));
		compacted.put("@context", context.get("@context"));
		JLDUtilities.assertEqualJLD(expect, compacted);
	}
	...
	*/
	...
	void t0023(){
		...
		Object expect=readResource("/compact/0023-out.jsonld");
		JSONObject context=(JSONObject)readResource("/compact/0023-context.jsonld");
		JSONObject compacted=JLDDocument.compact(input, context.get("@context"));
		compacted.put("@context", context.get("@context"));
		JLDUtilities.assertEqualJLD(expect, compacted);
	}
	...
	*/
	...
	void t0024(){
		...
		Object expect=readResource("/compact/0024-out.jsonld");
		JSONObject context=(JSONObject)readResource("/compact/0024-context.jsonld");
		JSONObject compacted=JLDDocument.compact(input, context.get("@context"));
		compacted.put("@context", context.get("@context"));
		JLDUtilities.assertEqualJLD(expect, compacted);
	}
	...
	*/
	...
	void t0025(){
		...
		Object expect=readResource("/compact/0025-out.jsonld");
		JSONObject context=(JSONObject)readResource("/compact/0025-context.jsonld");
		JSONObject compacted=JLDDocument.compact(input, context.get("@context"));
		compacted.put("@context", context.get("@context"));
		JLDUtilities.assertEqualJLD(expect, compacted);
	}
	...
	*/
	...
	void t0026(){
		...
		Object expect=readResource("/compact/0026-out.jsonld");
		JSONObject context=(JSONObject)readResource("/compact/0026-context.jsonld");
		JSONObject compacted=JLDDocument.compact(input, context.get("@context"));
		compacted.put("@context", context.get("@context"));
		JLDUtilities.assertEqualJLD(expect, compacted);
	}
	...
	*/
	...
	void t0027(){
		...
		Object expect=readResource("/compact/0027-out.jsonld");
		JSONObject context=(JSONObject)readResource("/compact/0027-context.jsonld");
		JSONObject compacted=JLDDocument.compact(input, context.get("@context"));
		compacted.put("@context", context.get("@context"));
		JLDUtilities.assertEqualJLD(expect, compacted);
	}
	...
	*/
	...
	void t0028(){
		...
		Object expect=readResource("/compact/0028-out.jsonld");
		JSONObject context=(JSONObject)readResource("/compact/0028-context.jsonld");
		JSONObject compacted=JLDDocument.compact(input, context.get("@context"));
		compacted.put("@context", context.get("@context"));
		JLDUtilities.assertEqualJLD(expect, compacted);
	}
	...
	*/
	...
	void t0029(){
		...
		Object expect=readResource("/compact/0029-out.jsonld");
		JSONObject context=(JSONObject)readResource("/compact/0029-context.jsonld");
		JSONObject compacted=JLDDocument.compact(input, context.get("@context"));
		compacted.put("@context", context.get("@context"));
		JLDUtilities.assertEqualJLD(expect, compacted);
	}
	...
	*/
	...
	void t0030(){
		...
		Object expect=readResource("/compact/0030-out.jsonld");
		JSONObject context=(JSONObject)readResource("/compact/0030-context.jsonld");
		JSONObject compacted=JLDDocument.compact(input, context.get("@context"));
		compacted.put("@context", context.get("@context"));
		JLDUtilities.assertEqualJLD(expect, compacted);
	}
	...
	*/
	...
	void t0031(){
		...
		Object expect=readResource("/compact/0031-out.jsonld");
		JSONObject context=(JSONObject)readResource("/compact/0031-context.jsonld");
		JSONObject compacted=JLDDocument.compact(input, context.get("@context"));
		compacted.put("@context", context.get("@context"));
		JLDUtilities.assertEqualJLD(expect, compacted);
	}
	...
	*/
	...
	void t0032(){
		...
		Object expect=readResource("/compact/0032-out.jsonld");
		JSONObject context=(JSONObject)readResource("/compact/0032-context.jsonld");
		JSONObject compacted=JLDDocument.compact(input, context.get("@context"));
		compacted.put("@context", context.get("@context"));
		JLDUtilities.assertEqualJLD(expect, compacted);
	}
	...
	*/
	...
	void t0033(){
		...
		Object expect=readResource("/compact/0033-out.jsonld");
		JSONObject context=(JSONObject)readResource("/compact/0033-context.jsonld");
		JSONObject compacted=JLDDocument.compact(input, context.get("@context"));
		compacted.put("@context", context.get("@context"));
		JLDUtilities.assertEqualJLD(expect, compacted);
	}
	...
	*/
	...
	void t0034(){
		...
		Object expect=readResource("/compact/0034-out.jsonld");
		JSONObject context=(JSONObject)readResource("/compact/0034-context.jsonld");
		JSONObject compacted=JLDDocument.compact(input, context.get("@context"));
		compacted.put("@context", context.get("@context"));
		JLDUtilities.assertEqualJLD(expect, compacted);
	}
	...
	*/
	...
	void t0035(){
		...
		Object expect=readResource("/compact/0035-out.jsonld");
		JSONObject context=(JSONObject)readResource("/compact/0035-context.jsonld");
		JSONObject compacted=JLDDocument.compact(input, context.get("@context"));
		compacted.put("@context", context.get("@context"));
		JLDUtilities.assertEqualJLD(expect, compacted);
	}
	...
	*/
	...
	void t0036(){
		...
		Object expect=readResource("/compact/0036-out.jsonld");
		JSONObject context=(JSONObject)readResource("/compact/0036-context.jsonld");
		JSONObject compacted=JLDDocument.compact(input, context.get("@context"));
		compacted.put("@context", context.get("@context"));
		JLDUtilities.assertEqualJLD(expect, compacted);
	}
	...
	*/
	...
	void t0037(){
		...
		Object expect=readResource("/compact/0037-out.jsonld");
		JSONObject context=(JSONObject)readResource("/compact/0037-context.jsonld");
		JSONObject compacted=JLDDocument.compact(input, context.get("@context"));
		compacted.put("@context", context.get("@context"));
		JLDUtilities.assertEqualJLD(expect, compacted);
	}
	...
	*/
	...
	void t0038(){
		...
		Object expect=readResource("/compact/0038-out.jsonld");
		JSONObject context=(JSONObject)readResource("/compact/0038-context.jsonld");
		JSONObject compacted=JLDDocument.compact(input, context.get("@context"));
		compacted.put("@context", context.get("@context"));
		JLDUtilities.assertEqualJLD(expect, compacted);
	}
	...
	*/
	...
	void t0039(){
		...
		Object expect=readResource("/compact/0039-out.jsonld");
		JSONObject context=(JSONObject)readResource("/compact/0039-context.jsonld");
		JSONObject compacted=JLDDocument.compact(input, context.get("@context"));
		compacted.put("@context", context.get("@context"));
		JLDUtilities.assertEqualJLD(expect, compacted);
	}
	...
	*/
	...
	void t0040(){
		...
		Object expect=readResource("/compact/0040-out.jsonld");
		JSONObject context=(JSONObject)readResource("/compact/0040-context.jsonld");
		JSONObject compacted=JLDDocument.compact(input, context.get("@context"));
		compacted.put("@context", context.get("@context"));
		JLDUtilities.assertEqualJLD(expect, compacted);
	}
	...
	*/
	...
	void t0041(){
		...
		Object expect=readResource("/compact/0041-out.jsonld");
		JSONObject context=(JSONObject)readResource("/compact/0041-context.jsonld");
		JSONObject compacted=JLDDocument.compact(input, context.get("@context"));
		compacted.put("@context", context.get("@context"));
		JLDUtilities.assertEqualJLD(expect, compacted);
	}
	...
	*/
	...
	void t0042(){
		...
		Object expect=readResource("/compact/0042-out.jsonld");
		JSONObject context=(JSONObject)readResource("/compact/0042-context.jsonld");
		JSONObject compacted=JLDDocument.compact(input, context.get("@context"));
		compacted.put("@context", context.get("@context"));
		JLDUtilities.assertEqualJLD(expect, compacted);
	}
	...
	*/
	...
	void t0043(){
		...
		Object expect=readResource("/compact/0043-out.jsonld");
		JSONObject context=(JSONObject)readResource("/compact/0043-context.jsonld");
		JSONObject compacted=JLDDocument.compact(input, context.get("@context"));
		compacted.put("@context", context.get("@context"));
		JLDUtilities.assertEqualJLD(expect, compacted);
	}
	...
	*/
	...
	void t0044(){
		...
		Object expect=readResource("/compact/0044-out.jsonld");
		JSONObject context=(JSONObject)readResource("/compact/0044-context.jsonld");
		JSONObject compacted=JLDDocument.compact(input, context.get("@context"));
		compacted.put("@context", context.get("@context"));
		JLDUtilities.assertEqualJLD(expect, compacted);
	}
	...
	*/
	...
	void t0045(){
		...
		Object expect=readResource("/compact/0045-out.jsonld");
		JSONObject context=(JSONObject)readResource("/compact/0045-context.jsonld");
		JSONObject compacted=JLDDocument.compact(input, context.get("@context"));
		compacted.put("@context", context.get("@context"));
		JLDUtilities.assertEqualJLD(expect, compacted);
	}
	...
	*/
	...
	void t0046(){
		...
		Object expect=readResource("/compact/0046-out.jsonld");
		JSONObject context=(JSONObject)readResource("/compact/0046-context.jsonld");
		JSONObject compacted=JLDDocument.compact(input, context.get("@context"));
		compacted.put("@context", context.get("@context"));
		JLDUtilities.assertEqualJLD(expect, compacted);
	}
	...
	*/
	...
	void t0047(){
		...
		Object expect=readResource("/compact/0047-out.jsonld");
		JSONObject context=(JSONObject)readResource("/compact/0047-context.jsonld");
		JSONObject compacted=JLDDocument.compact(input, context.get("@context"));
		compacted.put("@context", context.get("@context"));
		JLDUtilities.assertEqualJLD(expect, compacted);
	}
	...
	*/
	...
	void t0048(){
		...
		Object expect=readResource("/compact/0048-out.jsonld");
		JSONObject context=(JSONObject)readResource("/compact/0048-context.jsonld");
		JSONObject compacted=JLDDocument.compact(input, context.get("@context"));
		compacted.put("@context", context.get("@context"));
		JLDUtilities.assertEqualJLD(expect, compacted);
	}
	...
	*/
	...
	void t0049(){
		...
		Object expect=readResource("/compact/0049-out.jsonld");
		JSONObject context=(JSONObject)readResource("/compact/0049-context.jsonld");
		JSONObject compacted=JLDDocument.compact(input, context.get("@context"));
		compacted.put("@context", context.get("@context"));
		JLDUtilities.assertEqualJLD(expect, compacted);
	}
	...
	*/
	...
	void t0050(){
		...
		Object expect=readResource("/compact/0050-out.jsonld");
		JSONObject context=(JSONObject)readResource("/compact/0050-context.jsonld");
		JSONObject compacted=JLDDocument.compact(input, context.get("@context"));
		compacted.put("@context", context.get("@context"));
		JLDUtilities.assertEqualJLD(expect, compacted);
	}
	...
	*/
	...
	void t0051(){
		...
		Object expect=readResource("/compact/0051-out.jsonld");
		JSONObject context=(JSONObject)readResource("/compact/0051-context.jsonld");
		JSONObject compacted=JLDDocument.compact(input, context.get("@context"));
		compacted.put("@context", context.get("@context"));
		JLDUtilities.assertEqualJLD(expect, compacted);
	}
	...
	*/
	...
	void t0052(){
		...
		Object expect=readResource("/compact/0052-out.jsonld");
		JSONObject context=(JSONObject)readResource("/compact/0052-context.jsonld");
		JSONObject compacted=JLDDocument.compact(input, context.get("@context"));
		compacted.put("@context", context.get("@context"));
		JLDUtilities.assertEqualJLD(expect, compacted);
	}
	...
	*/
	...
	void t0053(){
		...
		Object expect=readResource("/compact/0053-out.jsonld");
		JSONObject context=(JSONObject)readResource("/compact/0053-context.jsonld");
		JSONObject compacted=JLDDocument.compact(input, context.get("@context"));
		compacted.put("@context", context.get("@context"));
		JLDUtilities.assertEqualJLD(expect, compacted);
	}
	...
	*/
	...
	void t0054(){
		...
		Object expect=readResource("/compact/0054-out.jsonld");
		JSONObject context=(JSONObject)readResource("/compact/0054-context.jsonld");
		JSONObject compacted=JLDDocument.compact(input, context.get("@context"));
		compacted.put("@context", context.get("@context"));
		JLDUtilities.assertEqualJLD(expect, compacted);
	}
	...
	*/
	...
	void t0055(){
		...
		Object expect=readResource("/compact/0055-out.jsonld");
		JSONObject context=(JSONObject)readResource("/compact/0055-context.jsonld");
		JSONObject compacted=JLDDocument.compact(input, context.get("@context"));
		compacted.put("@context", context.get("@context"));
		JLDUtilities.assertEqualJLD(expect, compacted);
	}
	...
	*/
	...
	void t0056(){
		...
		Object expect=readResource("/compact/0056-out.jsonld");
		JSONObject context=(JSONObject)readResource("/compact/0056-context.jsonld");
		JSONObject compacted=JLDDocument.compact(input, context.get("@context"));
		compacted.put("@context", context.get("@context"));
		JLDUtilities.assertEqualJLD(expect, compacted);
	}
	...
	*/
	...
	void t0057(){
		...
		Object expect=readResource("/compact/0057-out.jsonld");
		JSONObject context=(JSONObject)readResource("/compact/0057-context.jsonld");
		JSONObject compacted=JLDDocument.compact(input, context.get("@context"));
		compacted.put("@context", context.get("@context"));
		JLDUtilities.assertEqualJLD(expect, compacted);
	}
	...
	*/
	...
	void t0058(){
		...
		Object expect=readResource("/compact/0058-out.jsonld");
		JSONObject context=(JSONObject)readResource("/compact/0058-context.jsonld");
		JSONObject compacted=JLDDocument.compact(input, context.get("@context"));
		compacted.put("@context", context.get("@context"));
		JLDUtilities.assertEqualJLD(expect, compacted);
	}
	...
	*/
	...
	void t0059(){
		...
		Object expect=readResource("/compact/0059-out.jsonld");
		JSONObject context=(JSONObject)readResource("/compact/0059-context.jsonld");
		JSONObject compacted=JLDDocument.compact(input, context.get("@context"));
		compacted.put("@context", context.get("@context"));
		JLDUtilities.assertEqualJLD(expect, compacted);
	}
	...
	*/
	...
	void t0060(){
		...
		Object expect=readResource("/compact/0060-out.jsonld");
		JSONObject context=(JSONObject)readResource("/compact/0060-context.jsonld");
		JSONObject compacted=JLDDocument.compact(input, context.get("@context"));
		compacted.put("@context", context.get("@context"));
		JLDUtilities.assertEqualJLD(expect, compacted);
	}
	...
	*/
	...
	void t0061(){
		...
		Object expect=readResource("/compact/0061-out.jsonld");
		JSONObject context=(JSONObject)readResource("/compact/0061-context.jsonld");
		JSONObject compacted=JLDDocument.compact(input, context.get("@context"));
		compacted.put("@context", context.get("@context"));
		JLDUtilities.assertEqualJLD(expect, compacted);
	}
	...
	*/
	...
	void t0062(){
		...
		Object expect=readResource("/compact/0062-out.jsonld");
		JSONObject context=(JSONObject)readResource("/compact/0062-context.jsonld");
		JSONObject compacted=JLDDocument.compact(input, context.get("@context"));
		compacted.put("@context", context.get("@context"));
		JLDUtilities.assertEqualJLD(expect, compacted);
	}
	...
	*/
	...
	void t0063(){
		...
		Object expect=readResource("/compact/0063-out.jsonld");
		JSONObject context=(JSONObject)readResource("/compact/0063-context.jsonld");
		JSONObject compacted=JLDDocument.compact(input, context.get("@context"));
		compacted.put("@context", context.get("@context"));
		JLDUtilities.assertEqualJLD(expect, compacted);
	}
	...
	*/
	...
	void t0064(){
		...
		Object expect=readResource("/compact/0064-out.jsonld");
		JSONObject context=(JSONObject)readResource("/compact/0064-context.jsonld");
		JSONObject compacted=JLDDocument.compact(input, context.get("@context"));
		compacted.put("@context", context.get("@context"));
		JLDUtilities.assertEqualJLD(expect, compacted);
	}
	...
	*/
	...
	void t0065(){
		...
		Object expect=readResource("/compact/0065-out.jsonld");
		JSONObject context=(JSONObject)readResource("/compact/0065-context.jsonld");
		JSONObject compacted=JLDDocument.compact(input, context.get("@context"));
		compacted.put("@context", context.get("@context"));
		JLDUtilities.assertEqualJLD(expect, compacted);
	}
	...
	*/
	...
	void t0066(){
		...
		Object expect=readResource("/compact/0066-out.jsonld");
		JSONObject context=(JSONObject)readResource("/compact/0066-context.jsonld");
		JSONObject compacted=JLDDocument.compact(input, context.get("@context"));
		compacted.put("@context", context.get("@context"));
		JLDUtilities.assertEqualJLD(expect, compacted);
	}
	...
	*/
	...
	void t0067(){
		...
		Object expect=readResource("/compact/0067-out.jsonld");
		JSONObject context=(JSONObject)readResource("/compact/0067-context.jsonld");
		JSONObject compacted=JLDDocument.compact(input, context.get("@context"));
		compacted.put("@context", context.get("@context"));
		JLDUtilities.assertEqualJLD(expect, compacted);
	}
	...
	*/
	...
	void t0068(){
		...
		Object expect=readResource("/compact/0068-out.jsonld");
		JSONObject context=(JSONObject)readResource("/compact/0068-context.jsonld");
		JSONObject compacted=JLDDocument.compact(input, context.get("@context"));
		compacted.put("@context", context.get("@context"));
		JLDUtilities.assertEqualJLD(expect, compacted);
	}
	...
	*/
	...
	void t0069(){
		...
		Object expect=readResource("/compact/0069-out.jsonld");
		JSONObject context=(JSONObject)readResource("/compact/0069-context.jsonld");
		JSONObject compacted=JLDDocument.compact(input, context.get("@context"));
		compacted.put("@context", context.get("@context"));
		JLDUtilities.assertEqualJLD(expect, compacted);
	}
	...
	*/
	...
	void t0070(){
		...
		Object expect=readResource("/compact/0070-out.jsonld");
		JSONObject context=(JSONObject)readResource("/compact/0070-context.jsonld");
	...
	*/
	...
	void t0071(){
		...
		Object expect=readResource("/compact/0071-out.jsonld");
		JSONObject context=(JSONObject)readResource("/compact/0071-context.jsonld");
		JSONObject compacted=JLDDocument.compact(input, context.get("@context"));
		compacted.put("@context", context.get("@context"));
		JLDUtilities.assertEqualJLD(expect, compacted);
	}
	...
	*/
	...
	void t0072(){
		...
		Object expect=readResource("/compact/0072-out.jsonld");
		JSONObject context=(JSONObject)readResource("/compact/0072-context.jsonld");
		JSONObject compacted=JLDDocument.compact(input, context.get("@context"));
		compacted.put("@context", context.get("@context"));
		JLDUtilities.assertEqualJLD(expect, compacted);
	}
	...
	*/
	...
	void t0073(){
		...
		Object expect=readResource("/compact/0073-out.jsonld");
		JSONObject context=(JSONObject)readResource("/compact/0073-context.jsonld");
		JSONObject compacted=JLDDocument.compact(input, context.get("@context"));
		compacted.put("@context", context.get("@context"));
		JLDUtilities.assertEqualJLD(expect, compacted);
	}
	...
	*/
	...
	void t0074(){
		...
		Object expect=readResource("/compact/0074-out.jsonld");
		JSONObject context=(JSONObject)readResource("/compact/0074-context.jsonld");
		JSONObject compacted=JLDDocument.compact(input, context.get("@context"));
		compacted.put("@context", context.get("@context"));
		JLDUtilities.assertEqualJLD(expect, compacted);
	}
	...
	*/
	...
	void t0075(){
		...
		Object expect=readResource("/compact/0075-out.jsonld");
		JSONObject context=(JSONObject)readResource("/compact/0075-context.jsonld");
		JSONObject compacted=JLDDocument.compact(input, context.get("@context"));
		compacted.put("@context", context.get("@context"));
		JLDUtilities.assertEqualJLD(expect, compacted);
	}
	...
	*/
	...
	void t0076(){
		...
		Object expect=readResource("/compact/0076-out.jsonld");
		JSONObject context=(JSONObject)readResource("/compact/0076-context.jsonld");
		JSONObject compacted=JLDDocument.compact(input, context.get("@context"));
		compacted.put("@context", context.get("@context"));
		JLDUtilities.assertEqualJLD(expect, compacted);
	}
	...
	*/
	...
	void t0089(){
		...
		Object expect=readResource("/compact/0089-out.jsonld");
		JSONObject context=(JSONObject)readResource("/compact/0089-context.jsonld");
		JSONObject compacted=JLDDocument.compact(input, context.get("@context"));
		compacted.put("@context", context.get("@context"));
		JLDUtilities.assertEqualJLD(expect, compacted);
	}
	...
	*/
	...
	void t0095(){
		...
		Object expect=readResource("/compact/0095-out.jsonld");
		JSONObject context=(JSONObject)readResource("/compact/0095-context.jsonld");
		JSONObject compacted=JLDDocument.compact(input, context.get("@context"));
		compacted.put("@context", context.get("@context"));
		JLDUtilities.assertEqualJLD(expect, compacted);
	}
	...
	*/
	...
	void t0107(){
		...
		Object expect=readResource("/compact/0107-out.jsonld");
		JSONObject context=(JSONObject)readResource("/compact/0107-context.jsonld");
		JSONObject compacted=JLDDocument.compact(input, context.get("@context"));
		compacted.put("@context", context.get("@context"));
		JLDUtilities.assertEqualJLD(expect, compacted);
	}
	...
	*/
	...
	void t0108(){
		...
		Object expect=readResource("/compact/0108-out.jsonld");
		JSONObject context=(JSONObject)readResource("/compact/0108-context.jsonld");
		JSONObject compacted=JLDDocument.compact(input, context.get("@context"));
		compacted.put("@context", context.get("@context"));
		JLDUtilities.assertEqualJLD(expect, compacted);
	}
	...
	*/
	...
	void te001(){
		assertThrows(JLDException.class, ()->{
			...
			JSONObject context=(JSONObject)readResource("/compact/e001-context.jsonld");
	...
	*/
	...
	void tla01(){
		...
		Object expect=readResource("/compact/la01-out.jsonld");
		JSONObject context=(JSONObject)readResource("/compact/la01-context.jsonld");
		JSONObject compacted=JLDDocument.compact(input, context.get("@context"));
		compacted.put("@context", context.get("@context"));
		JLDUtilities.assertEqualJLD(expect, compacted);
	}
