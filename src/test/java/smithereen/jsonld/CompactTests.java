...
class CompactTests{
	...
	*/
	...
	void t0001(){
		JSONArray input=JLDProcessor.expandToArray(readResourceAsJSON("/compact/0001-in.jsonld"));
		...
		JSONObject compacted=JLDProcessor.compact(input, context.get("@context"));
	...
	*/
	...
	@DisplayName("basic")
	void t0002(){
		JSONArray input=JLDProcessor.expandToArray(readResourceAsJSON("/compact/0002-in.jsonld"));
	...
	*/
	...
	void t0003(){
		JSONArray input=JLDProcessor.expandToArray(readResourceAsJSON("/compact/0003-in.jsonld"));
	...
	*/
	...
	void t0004(){
		JSONArray input=JLDProcessor.expandToArray(readResourceAsJSON("/compact/0004-in.jsonld"));
	...
	*/
	...
	void t0005(){
		JSONArray input=JLDProcessor.expandToArray(readResourceAsJSON("/compact/0005-in.jsonld"));
	...
	*/
	...
	void t0006(){
		JSONArray input=JLDProcessor.expandToArray(readResourceAsJSON("/compact/0006-in.jsonld"));
	...
	*/
	...
	void t0007(){
		JSONArray input=JLDProcessor.expandToArray(readResourceAsJSON("/compact/0007-in.jsonld"));
	...
	*/
	...
	void t0008(){
		JSONArray input=JLDProcessor.expandToArray(readResourceAsJSON("/compact/0008-in.jsonld"));
	...
	*/
	...
	void t0009(){
		JSONArray input=JLDProcessor.expandToArray(readResourceAsJSON("/compact/0009-in.jsonld"));
	...
	*/
	...
	void t0010(){
		JSONArray input=JLDProcessor.expandToArray(readResourceAsJSON("/compact/0010-in.jsonld"));
	...
	*/
	...
	void t0011(){
		JSONArray input=JLDProcessor.expandToArray(readResourceAsJSON("/compact/0011-in.jsonld"));
	...
	*/
	...
	void t0012(){
		JSONArray input=JLDProcessor.expandToArray(readResourceAsJSON("/compact/0012-in.jsonld"));
	...
	*/
	...
	void t0013(){
		JSONArray input=JLDProcessor.expandToArray(readResourceAsJSON("/compact/0013-in.jsonld"));
	...
	*/
	...
	void t0014(){
		JSONArray input=JLDProcessor.expandToArray(readResourceAsJSON("/compact/0014-in.jsonld"));
	...
	*/
	...
	void t0015(){
		JSONArray input=JLDProcessor.expandToArray(readResourceAsJSON("/compact/0015-in.jsonld"));
	...
	*/
	...
	void t0016(){
		JSONArray input=JLDProcessor.expandToArray(readResourceAsJSON("/compact/0016-in.jsonld"));
	...
	*/
	...
	void t0017(){
		JSONArray input=JLDProcessor.expandToArray(readResourceAsJSON("/compact/0017-in.jsonld"));
	...
	*/
	...
	void t0018(){
		JSONArray input=JLDProcessor.expandToArray(readResourceAsJSON("/compact/0018-in.jsonld"));
	...
	*/
	...
	void t0019(){
		JSONArray input=JLDProcessor.expandToArray(readResourceAsJSON("/compact/0019-in.jsonld"));
	...
	*/
	...
	void t0020(){
		JSONArray input=JLDProcessor.expandToArray(readResourceAsJSON("/compact/0020-in.jsonld"));
	...
	*/
	...
	void t0021(){
		JSONArray input=JLDProcessor.expandToArray(readResourceAsJSON("/compact/0021-in.jsonld"));
	...
	*/
	...
	void t0022(){
		JSONArray input=JLDProcessor.expandToArray(readResourceAsJSON("/compact/0022-in.jsonld"));
	...
	*/
	...
	void t0023(){
		JSONArray input=JLDProcessor.expandToArray(readResourceAsJSON("/compact/0023-in.jsonld"));
	...
	*/
	...
	void t0024(){
		JSONArray input=JLDProcessor.expandToArray(readResourceAsJSON("/compact/0024-in.jsonld"));
	...
	*/
	...
	void t0025(){
		JSONArray input=JLDProcessor.expandToArray(readResourceAsJSON("/compact/0025-in.jsonld"));
	...
	*/
	...
	void t0026(){
		JSONArray input=JLDProcessor.expandToArray(readResourceAsJSON("/compact/0026-in.jsonld"));
	...
	*/
	...
	void t0027(){
		JSONArray input=JLDProcessor.expandToArray(readResourceAsJSON("/compact/0027-in.jsonld"));
	...
	*/
	...
	void t0028(){
		JSONArray input=JLDProcessor.expandToArray(readResourceAsJSON("/compact/0028-in.jsonld"));
	...
	*/
	...
	void t0029(){
		JSONArray input=JLDProcessor.expandToArray(readResourceAsJSON("/compact/0029-in.jsonld"));
	...
	*/
	...
	void t0030(){
		JSONArray input=JLDProcessor.expandToArray(readResourceAsJSON("/compact/0030-in.jsonld"));
	...
	*/
	...
	void t0031(){
		JSONArray input=JLDProcessor.expandToArray(readResourceAsJSON("/compact/0031-in.jsonld"));
	...
	*/
	...
	void t0032(){
		JSONArray input=JLDProcessor.expandToArray(readResourceAsJSON("/compact/0032-in.jsonld"));
	...
	*/
	...
	void t0033(){
		JSONArray input=JLDProcessor.expandToArray(readResourceAsJSON("/compact/0033-in.jsonld"));
	...
	*/
	...
	void t0034(){
		JSONArray input=JLDProcessor.expandToArray(readResourceAsJSON("/compact/0034-in.jsonld"));
	...
	*/
	...
	void t0035(){
		JSONArray input=JLDProcessor.expandToArray(readResourceAsJSON("/compact/0035-in.jsonld"));
	...
	*/
	...
	void t0036(){
		JSONArray input=JLDProcessor.expandToArray(readResourceAsJSON("/compact/0036-in.jsonld"));
	...
	*/
	...
	void t0037(){
		JSONArray input=JLDProcessor.expandToArray(readResourceAsJSON("/compact/0037-in.jsonld"));
	...
	*/
	...
	void t0038(){
		JSONArray input=JLDProcessor.expandToArray(readResourceAsJSON("/compact/0038-in.jsonld"));
	...
	*/
	...
	void t0039(){
		JSONArray input=JLDProcessor.expandToArray(readResourceAsJSON("/compact/0039-in.jsonld"));
	...
	*/
	...
	void t0040(){
		JSONArray input=JLDProcessor.expandToArray(readResourceAsJSON("/compact/0040-in.jsonld"));
	...
	*/
	...
	void t0041(){
		JSONArray input=JLDProcessor.expandToArray(readResourceAsJSON("/compact/0041-in.jsonld"));
	...
	*/
	...
	void t0042(){
		JSONArray input=JLDProcessor.expandToArray(readResourceAsJSON("/compact/0042-in.jsonld"));
	...
	*/
	...
	void t0043(){
		JSONArray input=JLDProcessor.expandToArray(readResourceAsJSON("/compact/0043-in.jsonld"));
	...
	*/
	...
	void t0044(){
		JSONArray input=JLDProcessor.expandToArray(readResourceAsJSON("/compact/0044-in.jsonld"));
	...
	*/
	...
	void t0045(){
		JSONArray input=JLDProcessor.expandToArray(readResourceAsJSON("/compact/0045-in.jsonld"));
	...
	*/
	...
	void t0046(){
		JSONArray input=JLDProcessor.expandToArray(readResourceAsJSON("/compact/0046-in.jsonld"));
	...
	*/
	...
	void t0047(){
		JSONArray input=JLDProcessor.expandToArray(readResourceAsJSON("/compact/0047-in.jsonld"));
	...
	*/
	...
	void t0048(){
		JSONArray input=JLDProcessor.expandToArray(readResourceAsJSON("/compact/0048-in.jsonld"));
	...
	*/
	...
	void t0049(){
		JSONArray input=JLDProcessor.expandToArray(readResourceAsJSON("/compact/0049-in.jsonld"));
	...
	*/
	...
	void t0050(){
		JSONArray input=JLDProcessor.expandToArray(readResourceAsJSON("/compact/0050-in.jsonld"));
	...
	*/
	...
	void t0051(){
		JSONArray input=JLDProcessor.expandToArray(readResourceAsJSON("/compact/0051-in.jsonld"));
	...
	*/
	...
	void t0052(){
		JSONArray input=JLDProcessor.expandToArray(readResourceAsJSON("/compact/0052-in.jsonld"));
	...
	*/
	...
	void t0053(){
		JSONArray input=JLDProcessor.expandToArray(readResourceAsJSON("/compact/0053-in.jsonld"));
	...
	*/
	...
	void t0054(){
		JSONArray input=JLDProcessor.expandToArray(readResourceAsJSON("/compact/0054-in.jsonld"));
	...
	*/
	...
	void t0055(){
		JSONArray input=JLDProcessor.expandToArray(readResourceAsJSON("/compact/0055-in.jsonld"));
	...
	*/
	...
	void t0056(){
		JSONArray input=JLDProcessor.expandToArray(readResourceAsJSON("/compact/0056-in.jsonld"));
	...
	*/
	...
	void t0057(){
		JSONArray input=JLDProcessor.expandToArray(readResourceAsJSON("/compact/0057-in.jsonld"));
	...
	*/
	...
	void t0058(){
		JSONArray input=JLDProcessor.expandToArray(readResourceAsJSON("/compact/0058-in.jsonld"));
	...
	*/
	...
	void t0059(){
		JSONArray input=JLDProcessor.expandToArray(readResourceAsJSON("/compact/0059-in.jsonld"));
	...
	*/
	...
	void t0060(){
		JSONArray input=JLDProcessor.expandToArray(readResourceAsJSON("/compact/0060-in.jsonld"));
	...
	*/
	...
	void t0061(){
		JSONArray input=JLDProcessor.expandToArray(readResourceAsJSON("/compact/0061-in.jsonld"));
	...
	*/
	...
	void t0062(){
		JSONArray input=JLDProcessor.expandToArray(readResourceAsJSON("/compact/0062-in.jsonld"));
	...
	*/
	...
	void t0063(){
		JSONArray input=JLDProcessor.expandToArray(readResourceAsJSON("/compact/0063-in.jsonld"));
	...
	*/
	...
	void t0064(){
		JSONArray input=JLDProcessor.expandToArray(readResourceAsJSON("/compact/0064-in.jsonld"));
	...
	*/
	...
	void t0065(){
		JSONArray input=JLDProcessor.expandToArray(readResourceAsJSON("/compact/0065-in.jsonld"));
	...
	*/
	...
	void t0066(){
		JSONArray input=JLDProcessor.expandToArray(readResourceAsJSON("/compact/0066-in.jsonld"));
	...
	*/
	...
	void t0067(){
		JSONArray input=JLDProcessor.expandToArray(readResourceAsJSON("/compact/0067-in.jsonld"));
	...
	*/
	...
	void t0068(){
		JSONArray input=JLDProcessor.expandToArray(readResourceAsJSON("/compact/0068-in.jsonld"));
	...
	*/
	...
	void t0069(){
		JSONArray input=JLDProcessor.expandToArray(readResourceAsJSON("/compact/0069-in.jsonld"));
	...
	*/
	...
	void t0070(){
		JSONArray input=JLDProcessor.expandToArray(readResourceAsJSON("/compact/0070-in.jsonld"));
		...
		JSONObject compacted=JLDProcessor.compact(input, context.get("@context"), false);
		assertEqualJLD(expect, compacted);
	}
	...
	*/
	...
	void t0071(){
		JSONArray input=JLDProcessor.expandToArray(readResourceAsJSON("/compact/0071-in.jsonld"));
	...
	*/
	...
	void t0072(){
		JSONArray input=JLDProcessor.expandToArray(readResourceAsJSON("/compact/0072-in.jsonld"));
	...
	*/
	...
	void t0073(){
		JSONArray input=JLDProcessor.expandToArray(readResourceAsJSON("/compact/0073-in.jsonld"));
	...
	*/
	...
	void t0074(){
		JSONArray input=JLDProcessor.expandToArray(readResourceAsJSON("/compact/0074-in.jsonld"));
	...
	*/
	...
	void t0075(){
		JSONArray input=JLDProcessor.expandToArray(readResourceAsJSON("/compact/0075-in.jsonld"));
	...
	*/
	...
	void t0076(){
		JSONArray input=JLDProcessor.expandToArray(readResourceAsJSON("/compact/0076-in.jsonld"));
	...
	*/
	...
	@DisplayName("Language map term selection with complications")
	void t0089(){
		JSONArray input=JLDProcessor.expandToArray(readResourceAsJSON("/compact/0089-in.jsonld"));
	...
	*/
	...
	void t0095(){
		JSONArray input=JLDProcessor.expandToArray(readResourceAsJSON("/compact/0095-in.jsonld"));
	...
	*/
	...
	@DisplayName("Relative propererty IRIs with @vocab: ''")
	void t0107(){
		JSONArray input=JLDProcessor.expandToArray(readResourceAsJSON("/compact/0107-in.jsonld"));
	...
	*/
	...
	void t0108(){
		JSONArray input=JLDProcessor.expandToArray(readResourceAsJSON("/compact/0108-in.jsonld"));
	...
	*/
	...
	void te001(){
		assertThrows(JLDException.class, ()->{
			JSONArray input=JLDProcessor.expandToArray(readResourceAsJSON("/compact/e001-in.jsonld"));
	...
	*/
	...
	@DisplayName("most specific term matching in @list.")
	void tla01(){
		JSONArray input=JLDProcessor.expandToArray(readResourceAsJSON("/compact/la01-in.jsonld"));
