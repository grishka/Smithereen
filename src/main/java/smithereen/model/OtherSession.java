...
public record OtherSession(int id, InetAddress ip, Instant lastActive, String userAgent, BrowserInfo browserInfo, byte[] fullID, long appID){
	public static OtherSession fromResultSet(ResultSet res) throws SQLException{
		...
		return new OtherSession((int)Utils.unpackLong(id),
