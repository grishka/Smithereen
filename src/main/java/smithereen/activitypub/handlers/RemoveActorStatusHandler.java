...
public class RemoveActorStatusHandler extends ActivityTypeHandler<Actor, Remove, ActivityPubActorStatus>{
	@Override
	public void handle(ActivityHandlerContext context, Actor actor, Remove activity, ActivityPubActorStatus object) throws SQLException{
