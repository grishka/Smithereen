...
public class UserRemovePhotoHandler extends ActivityTypeHandler<ForeignUser, Remove, ActivityPubPhoto>{
	@Override
	public void handle(ActivityHandlerContext context, ForeignUser actor, Remove activity, ActivityPubPhoto object){
